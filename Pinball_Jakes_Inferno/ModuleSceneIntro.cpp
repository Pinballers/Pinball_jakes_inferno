...
bool ModuleSceneIntro::Start()
{
	...
	left_piece1 = App->physics->CreateStaticChain(25, 34, left_piece1_points, 238);
	right_piece1 = App->physics->CreateStaticChain(25, 34, right_piece1_points, 238);
	left_piece2 = App->physics->CreateStaticChain(25, 34, left_piece2_points, 238);
	right_piece2 = App->physics->CreateStaticChain(25, 34, right_piece2_points, 238);
	left_wheel_piece = App->physics->CreateStaticChain(25, 34, left_wheel_piece_points, 238);
	right_wheel_piece = App->physics->CreateStaticChain(25, 34, right_wheel_piece_points, 238);
	...
	left_flipper_bot_def.bodyB = left_flipper->body;
	...
	right_flipper_bot_def.bodyB = right_flipper->body;
...
update_status ModuleSceneIntro::Update()
{
	...
	App->renderer->Blit(left_piece1_tex, 0, 0);
	App->renderer->Blit(right_piece1_tex, 0, 0);
	App->renderer->Blit(left_piece2_tex, 0, 0);
	App->renderer->Blit(right_piece2_tex, 0, 0);
	//Flippers
